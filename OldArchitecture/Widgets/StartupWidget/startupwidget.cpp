	...
	: QWidget(parent)
{
	...
	startupWidgetPalette.setColor(QPalette::Background, QColor(68, 68, 68, 255));
	...
	descriptionTextPalette.setColor(QPalette::WindowText, QColor(204, 204, 204));

	//Set the error text palette to red 
	errorTextPalette.setColor(QPalette::WindowText, QColor(255, 150, 0, 255));

	//Set the line edit palette to a dark grey with white text
	lineEditPalette.setColor(QPalette::Base, QColor(42, 42, 42));
	lineEditPalette.setColor(QPalette::Text, QColor(204, 204, 204));
...
void StartupWidget::onCoreReadyToStart()
{
	...
	wirelessNetworkNameLineEdit->setPalette(lineEditPalette);
	wirelessNetworkNameLineEdit->setStyleSheet("border: 1px solid #515151; background-color: #2A2A2A");
	...
	wirelessNetworkPasswordLineEdit->setPalette(lineEditPalette);
	wirelessNetworkPasswordLineEdit->setStyleSheet("border: 1px solid #515151; background-color: #2A2A2A");
	...
	internetConnectionComboBox->setStyleSheet("border: 1px solid #515151; background-color: #2A2A2A");
