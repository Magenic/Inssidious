...
Start::Start(QWidget *parent, QList<QString> networkConnectionDescriptions)
	: QWidget(parent)
{
...
void Start::onStartButtonClicked()
{
...
void Start::onUpdateStatus(QString newStatusMessage, bool error)
{
